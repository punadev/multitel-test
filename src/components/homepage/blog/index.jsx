  ...
  const blogPosts = [
    {
      ...
      description: 'The latest trends in technology and how they are shaping our future.',
    ...
    },
    {
      ...
      description: 'How artificial intelligence is transforming the job market.',
      image: 'https://images.unsplash.com/photo-1486406146926-c627a92ad1ab?auto=format&fit=crop&q=80&w=500',
      category: 'Business',
      date: 'Mar 14, 2024',
      tags: ['AI', 'Job Market', 'Digital Transformation'],
      author: {
        ...
        <motion.div
          ...
          >
            <h2 className="text-4xl mt-2 leading-tight">
              <span className="text-blue-800 font-semibold">Discover </span>
          ...
          Articles, analysis, and reflections on technology, business, and innovation.
          </p>
        </div>
